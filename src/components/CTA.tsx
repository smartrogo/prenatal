      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-10">
          ...
          <div className="space-y-8 animate-fade-in">
            {/* Enhanced Badge */}
            <div className="inline-flex items-center gap-3 bg-gradient-card px-8 py-4 rounded-full border border-border shadow-glow hover:shadow-primary/30 transition-all duration-500 group">
              <Crown className="w-6 h-6 text-primary group-hover:animate-bounce" />
              <span className="font-semibold text-foreground text-lg">Join 15,000+ Mothers Who Trust Prenatal</span>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-4">
            <Button variant="hero" size="lg" className="text-2xl px-16 py-10 font-bold group relative overflow-hidden hover:scale-105 transition-all duration-300">
              <span className="relative z-10 flex items-center">
                Start Your Journey Free
                <Heart className="w-7 h-7 ml-4 group-hover:animate-pulse text-white" />
              </span>
              <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
            </Button>
            <Button variant="soft" size="lg" className="text-2xl px-16 py-10 group hover:scale-105 transition-all duration-300">
              Book Personal Demo
              <Star className="w-7 h-7 ml-4 group-hover:text-primary transition-colors" />
            </Button>
          </div>

          {/* Enhanced Trust Indicators */}
          <div className="pt-12 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-lg font-medium text-muted-foreground">
              <div className="flex items-center justify-center gap-3 group hover:text-foreground transition-colors">
              ...
              <div className="flex items-center justify-center gap-3 group hover:text-foreground transition-colors">
                <div className="w-3 h-3 rounded-full bg-secondary animate-pulse delay-700"></div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 text-lg">
              <div className="flex items-center gap-3 bg-gradient-card px-6 py-3 rounded-full border border-border shadow-soft hover:shadow-glow transition-all duration-300 group">
